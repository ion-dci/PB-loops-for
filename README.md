...
|                 Status                  | Check                                                                                    |
| :-------------------------------------: | :--------------------------------------------------------------------------------------- |
| ![Status](../../blob/badges/.github/badges/autograding-solution/status0.svg) | 1. Addition: the sum of the numbers 1 to 20 must be printed in the terminal |
| ![Status](../../blob/badges/.github/badges/autograding-solution/status1.svg) | 2. There are i bottles of beer on the wall: must be printed 5 times in the terminal where i equals each number from 1 to 5 |
| ![Status](../../blob/badges/.github/badges/autograding-solution/status2.svg) | 3. The odd/even reporter: each number between 0 and 20 must be printed in the terminal using the correct form ('i is even' or 'i is odd') |
| ![Status](../../blob/badges/.github/badges/autograding-solution/status3.svg) | 4. Multiplication Tables: the multiplication of each number between 1 and 10 by 9 must be printed in the terminal |
| ![Status](../../blob/badges/.github/badges/autograding-solution/status4.svg) | 5. Fizz Buzz |
| ![Status](../../blob/badges/.github/badges/autograding-solution/status5.svg) | 6. Sum of Multiples |
